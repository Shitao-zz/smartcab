...
class LearningAgent(Agent):
	...
	self.states = [(light, oncoming,left,right,next_waypoint)
	    for light in ('red','green')
            for oncoming in ('forward','left','right',None)
            for left in ('forward','left','right',None)
            for right in ('forward','left','right',None)		    
	...
	new_state = (new_input['light'],new_input['oncoming'],new_input['left'],new_input['right'],new_next_waypoint)
